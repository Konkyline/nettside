...
export default function Inspired(props: PageProps) {
  ...
  return (
    <>
      ...
      <body class="relative flex flex-wrap snap-x gap-4 z-0 justify-center align-center overflow-y-auto overflow-x-hidden" style="scroll-snap-type: y mandatory;">
        {domains.map(domain => (
          <iframe src={`https://www.${domain}`} class="w-full h-screen transform scale-50" style="scroll-snap-align: center;" />
        ))}
